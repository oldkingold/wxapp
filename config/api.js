...
module.exports = {
  ...
  bm_refund_part: ApiRootUrl + "wxapp/Vip1/bm_refund_part",  //报名订单申请退款
  bm_refund_cancel: ApiRootUrl + "wxapp/Vip1/bm_refund_cancel",  //报名订单申请退款
  //discountreceipt.js
  ...
  //discount
  ml: { 
    state: ApiRootUrl + "wxapp/ml/state",
    levelType: ApiRootUrl + "wxapp/ml/levelType",
    }
}